  ...
  return (
    <>
        ...
        <div className='content flex place-content-center pt-20 pb-20'>
          <div className='quizac px-5'>
            ...
            <div className="socials flex mt-6">
              <li className='footer-icons'><FaFacebook size='2rem'/></li>
              <li className='footer-icons'><FaTwitter size='2rem'/></li>
              <li className='footer-icons'><FaInstagram size='2rem'/></li>
            </div>
          </div>
          <div className='about px-6'>
            <ul>
            {
              About.map((con, index) => {
                ...
                return(
                  <div key={index}>
                    <li className='py-1 hover:text-orange-600'>
      ...
      <div className='footer-footer'>
          <p>&copy; 2021 <span className='text-orange-600'>Quizac inc.</span> All Rights Reserved</p>
      </div>
    </>
  )
}
